...
"""
SAMPLE_INFO2 = """
당신은 락헤드 마틴 기업에 대해 알아두어야 합니다. 제가 물어보면 알려주세요.

락헤드 마틴은 세계 최고의 항공우주, 방위, 보안 및 첨단 기술 기업으로서 혁신적인 솔루션을 제공하고 있습니다.
...
락헤드 마틴은 이번 전시회에 혁신적인 상품을 가져왔습니다.
...
락헤드 마틴의 Ring wing은 혁신적이며 시험적인 구조를 가졌기 때문에 상용화에 매우 신중하게 접근하고 있습니다. 락헤드 마틴은 이 혁신적인 기체를 함께 만들어갈 기업을 찾고 있습니다.

Q&A

Q. 기술 혁신과 관련해 락헤드 마틴이 현재 집중하고 있는 연구 및 개발 분야에 대해 설명해 주실 수 있을까요?
A. 락헤드 마틴은 여러 항공기, 우주 탐사 시스템 등 다양한 분야에서 최첨단 기술 개발에 집중하고 있습니다.
